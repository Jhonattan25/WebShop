    ...
    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity http) {
        ...
        http.authorizeExchange( e ->
                    e.pathMatchers("/api/auth/**").permitAll()
                            ...
                            .pathMatchers(HttpMethod.GET,"/api/purchase/").hasRole(ADMIN)
                            .pathMatchers(HttpMethod.GET,"/api/purchase/{id}").hasAnyRole(ADMIN, USER)
                            .pathMatchers(HttpMethod.POST,"/api/purchase/add").hasAnyRole(ADMIN, USER)
                            .pathMatchers(HttpMethod.PUT,"/api/purchase/update/{id}").hasAnyRole(ADMIN)
